    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-green-800 p-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold text-black-900 mb-6">About PlantID</h1>
          ...
          <h2 className="text-2xl font-semibold text-black-900 mt-8 mb-4">How It Works</h2>
          <ol className="list-decimal list-inside space-y-2 text-black-900">
